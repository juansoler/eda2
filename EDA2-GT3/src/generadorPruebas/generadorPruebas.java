...
public class generadorPruebas {
	...
	private static int contadorEmpresasAltas = 2;  // va contando el numero de contaminantes altos generados, cuando llegue al max no genera mas
	private static int numMaxEmpresasContaminantes = 25;   // seleciona el numero máximo de empresas con contaminantes altos.
	private static boolean contaminadorAltoPorEmpresa = false;  // si una empresa ya tiene un contaminante alto, no genera otro.
	...
	public static void main(String[] args) {
		...
		int numeroCalles = 6; // numero de calles
		int numeroAvenidas = 6;  // numero de avneidas
		String nombreFichero = directorio + "pruebaN7.txt";
		int numContaminantes = 20;  // numero de contaminantes
		...
		}else generarFichero(directorio + args[0], Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]), Integer.parseInt(args[4]));
		// B= 66  Z=90
